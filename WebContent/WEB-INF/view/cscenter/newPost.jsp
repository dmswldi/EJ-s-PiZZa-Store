...
<div class="container mt-5">
	<div class="row">
		...
		<div class="col-6">
			...
			<small class="form-text text-muted">We are always open to you.</small>
			<br />
			<form action="${root }/cs/write.do" method="post">
			  ...
			  <div class="form-group">
			    ...
			    <textarea class="form-control" id="content" name="content" rows="20" required>${param.title }</textarea>
			  </div>
			</form>
		</div>
	</div>
