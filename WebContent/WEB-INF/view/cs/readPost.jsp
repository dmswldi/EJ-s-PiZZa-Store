		...
		<div class="col-6">
			...
			<form action="${root }/cs/write.do" method="post">
			  <div class="form-group">
			    <small class="form-text text-muted">${param.id }id</small>
			    <small class="form-text text-muted float-right">${param.date }date</small>
			  </div>
			  <div class="form-group">
			  ...
			  <button type="submit" class="btn btn-primary float-right" hidden=true>Save</button>
			</form>
			<button class="btn btn-secondary float-right" hidden=true>Revise</button>
		</div>
	</div>
</div>
</body>
